...
if( !class_exists( 'Woo_Product_Attr_Plus_WP_Plugin_Settings_Page' ) ) {
    ...
    class Woo_Product_Attr_Plus_WP_Plugin_Settings_Page {
        ...
        public function __construct() {
            ...
            $this->sections = [
                '' => esc_html__( 'Variable Product', 'pap' ),
            ];
        ...
        public function get_settings_for_default_section() {
            $settings = [
                [
                    'title' => esc_html__( 'Configure swatch settings for the variable product detail page.', 'pap' ),
                    'type'  => 'title',
                    'desc'  => '',
                    'id'    => 'variable_product_woo_pap_swatch_options',
                ],
                    [
                        'title'   => esc_html__( 'Manage Swatch', 'pap' ),
                        'desc'    => esc_html__( 'Toggle the display of swatches in the variable product detail page.', 'pap' ),
                        'id'      => 'woo_pap_manage_swatch_vproduct',
                        'default' => 'yes',
                        'type'    => 'checkbox',
                    ],
                    [
                        'title'    => esc_html__( 'Swatch Size', 'pap' ),
                        'desc'     => esc_html__( 'Select the size of the swatch to be displayed on the variable product detail page.', 'pap' ),
                    ...
                    [
                        'title'    => esc_html__( 'Swatch Shape', 'pap' ),
                        'desc'     => esc_html__( 'Select the shape of the swatch to be displayed on the variable product detail page.', 'pap' ),
                    ...
                    [
                        'title'    => esc_html__( 'Swatch Hover Border Color', 'pap' ),
                        'desc'     => esc_html__( 'The border color of the swatch was set when hovered.', 'pap' ),
                    ...
                    [
                        'title'    => esc_html__( 'Active Swatch Border Color', 'pap' ),
                        'desc'     => esc_html__( 'Set the border color of the selected swatch.', 'pap' ),
