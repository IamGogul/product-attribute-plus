    ...
    class WCPAPLUS_WP_Plugin_Products {
        ...
        public function wc_product_option_terms( $attribute_taxonomy, $index, $attribute ) {
            ...
            printf('<select
                ...
                data-taxonomy             = "%4$s">',
                esc_attr( $index ),
                esc_attr__( 'Select terms', 'product-attribute-plus'),
            ...
            printf( '
                ...
                esc_attr( $attribute->get_taxonomy() ),
                esc_html__( 'Add new', 'product-attribute-plus' )
            );
...
if( !function_exists( 'prod_attr_plus_wp_plugin_products' ) ) {

    /**
     * Returns the instance of a class.
     */
    function prod_attr_plus_wp_plugin_products() {

        return WCPAPLUS_WP_Plugin_Products::get_instance();
    }
}

prod_attr_plus_wp_plugin_products();
